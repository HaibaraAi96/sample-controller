...
import (
	...
	icecreamclientset "k8s.io/sample-controller/pkg/client_icecream/clientset/versioned"
	icecreaminformers "k8s.io/sample-controller/pkg/client_icecream/informers/externalversions"
)
